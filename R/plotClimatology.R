...
plotClimatology <- function(grid, backdrop.theme = "none", set.min = NULL, set.max = NULL, lonCenter = NULL, ...) {
    .Deprecated("spatialPlot", package = "visualizeR",
                msg = "'plotClimatology' is deprecated and will eventually be removed from transformeR.\nUse 'spatialPlot' from package visualizeR instead.") 
    arg.list <- list(...)
