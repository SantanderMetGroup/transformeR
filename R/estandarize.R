...
#' @description Estandarize all given variables of a dataset to 0 mean and 1 unit standard deviation. If the input dataset if a dataset used for test or validation then it is standarized by the train mean and standard deviations.
...
#' @param grid.ref If the grid is a "test" dataset then this parameter is the grid object of the "train" dataset as returned from \code{\link[downscaleR]{prepare_predictors}}.
#' @return A new grid object with estandarized values.
#' @details The function estandarizes via the base R function \code{\link[base]{scale}}.
